...
public class OptionPanel implements TextTranslator {
    ...
    private Vector getControls() {
        ...
        // svs: do not use hardcoded lafs
        //int reservedCount = 6;
        int reservedCount = 4; // additional lafs
...
//        }
        int i = 0;
        for(LookAndFeelInfo inf: lafInfo){
            lafNames[i] = inf.getClassName();
            translatedLafNames.add(inf.getName());
            i++;
        }

        lafNames[i] = "com.formdev.flatlaf.FlatLightLaf"; translatedLafNames.add("FlatLaf Light"); i++;
        lafNames[i] = "com.formdev.flatlaf.FlatDarkLaf"; translatedLafNames.add("FlatLaf Dark"); i++;
        lafNames[i] = "com.formdev.flatlaf.FlatDarculaLaf"; translatedLafNames.add("FlatLaf Darcula"); i++;
        lafNames[i] = "com.formdev.flatlaf.FlatIntelliJLaf"; translatedLafNames.add("FlatLaf IntelliJ"); i++;
